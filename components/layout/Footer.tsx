      ...
      <div style={{ padding: "4rem 1.5rem 3rem", maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "3rem" }}>
          ...
          <div style={{ gridColumn: "span 1" }}>
            <img src="https://res.cloudinary.com/dile6kx4g/image/upload/w_1200,q_80,f_jpg/logo_transparent_i5re94.jpg" alt="AspenLeaf Painting" style={{ height: 52, width: "auto", marginBottom: "1.25rem", filter: "brightness(0) invert(1)" }} width={200} height={52} />
